...
export const CHANGELOG: ChangelogEntry[] = [
    {
        ...
        changes: [
            ...
            '— DaKS Berlin Recherche —',
            'Neuer Bereich im Admin-Panel: Alle Mitglieds-Kitas von daks-berlin.de per Knopfdruck abrufen. Zeigt Name, Adresse, Bezirk, Telefon, E-Mail, Träger und Platzzahl in einer durchsuchbaren Tabelle.',
