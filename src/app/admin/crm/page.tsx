        ...
        <div style={{ padding: '2rem', maxWidth: '1400px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', alignItems: 'center', marginBottom: '1rem', flexWrap: 'wrap' }}>
                ...
                >
                    ...
                    <option value="kitanetz">Kitanetz</option>
                                    ...
                                    <tr key={p.id} style={{ borderBottom: '1px solid var(--border-color)' }}>
                                        ...
                                        <td style={{ padding: '9px 12px', whiteSpace: 'nowrap' }}>
                                            <span style={{
                                                ...
                                                fontSize: '11px',
                                                fontWeight: 600,
                                                background: p.source === 'daks' ? 'rgba(59,130,246,0.12)' : p.source === 'kita-navigator' ? 'rgba(168,85,247,0.12)' : p.source === 'senatsliste' ? 'rgba(22,163,74,0.12)' : p.source === 'kietzee' ? 'rgba(249,115,22,0.12)' : p.source === 'kitanetz' ? 'rgba(8,145,178,0.12)' : 'rgba(148,163,184,0.12)',
                                                color: p.source === 'daks' ? '#3b82f6' : p.source === 'kita-navigator' ? '#a855f7' : p.source === 'senatsliste' ? '#16a34a' : p.source === 'kietzee' ? '#f97316' : p.source === 'kitanetz' ? '#0891b2' : '#94a3b8',
